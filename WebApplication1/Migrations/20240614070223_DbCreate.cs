    ...
    public partial class DbCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdCient = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clients", x => x.IdCient);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RenewalMethod = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdSubscription = table.Column<int>(type: "int", nullable: false),
                    ClientIdCient = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payments", x => x.IdPayment);
                    table.ForeignKey(
                        name: "FK_Payments_Clients_ClientIdCient",
                        column: x => x.ClientIdCient,
                        principalTable: "Clients",
                        principalColumn: "IdCient");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ClientIdCient",
                table: "Payments",
                column: "ClientIdCient");
